 ...
 * @author：于起宇 <br/>
 * =============================== Created with Eclipse. Date：2017/10/26 Time：19:28
...
public class RabbitMqFastJsonConverter extends AbstractMessageConverter {
	...
	protected Message createMessage(Object msg, MessageProperties messageProperties) {
		...
		classMapper.fromClass(msg.getClass(), messageProperties);
	...
	protected Message createMessage(Object objectToConvert, MessageProperties messageProperties)
		...
		if (getClassMapper() == null) {
			getJavaTypeMapper().fromJavaType(this.jsonObjectMapper.constructType(objectToConvert.getClass()), messageProperties);
		} else {
